...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Quality Bra",
    price: 39,
    description: "Quality Bra For Women",
    fullDescription:
      "Quality Bra For women, kindly tell us the size and color you would be needing.",
    images: [
      "/Quality Bra1.jpg",
      "/Quality Bra2.jpg",
      "/Quality Bra3.jpg",
    ...
    name: "Quality Pants",
    price: 43,
    description: "Quality Pants For Women",
    fullDescription:
      "Explore our exquisite collection of quality pants for women, featuring a variety of styles and fits to suit every taste. Whether you prefer classic cuts or modern designs, we have the perfect pair of pants for you.",
    images: [
      "/Quality Pants.jpg",
      "/Quality Pants1.jpg",
      "/Quality Pants2.jpg",
    ...
    name: "Men Boxer",
    price: 39,
    description: "Stylish men boxers in multiple designs",
    fullDescription:
      "Explore our exquisite collection of men boxers, featuring a variety of designs to suit every taste. Whether you prefer classic styles or modern patterns, we have the perfect pair for you.",
    images: [
      "/Men Boxer.jpg",
      "/Men Boxer1.jpg",
      "/Men Boxer2.jpg",
