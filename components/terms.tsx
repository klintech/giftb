    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-8 text-foreground/80 leading-relaxed">
          Welcome to Giftbridge! These Terms of Service ("Terms") govern your access to and use of our services. By using the Service, you agree to be bound by these Terms.
        </p>
        ...
        <div className="flex flex-col gap-2">
            <p className="text-foreground">
                Email: <span className="text-primary hover:underline">support@gift-bridge.xyz</span>
            </p>
        </div>
